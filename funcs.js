...
async function durationString(duration){
    ...
    const string = `${moment.duration(duration).get('years') !== 0 `${moment.duration(duration).get('years')} year${moment.duration(duration).get('years') !== 1 ? 's' : ''}`} ${moment.duration(duration).get('months') !== 0 `${moment.duration(duration).get('months')} month${moment.duration(duration).get('months') !== 1 ? 's' : ''}`} ${moment.duration(duration).get('day') !== 0 `${moment.duration(duration).get('days')} day${moment.duration(duration).get('days') !== 1 ? 's' : ''}`} ${moment.duration(duration).get('hours') !== 0 `${moment.duration(duration).get('hours')} hour${moment.duration(duration).get('hours') !== 1 ? 's' : ''}`} ${moment.duration(duration).get('minutes') !== 0 `${moment.duration(duration).get('minutes')} minute${moment.duration(duration).get('minutes') !== 1 ? 's' : ''}`} ${moment.duration(duration).get('seconds') !== 0 `${moment.duration(duration).get('seconds')} second${moment.duration(duration).get('seconds') !== 1 ? 's' : ''}`}`
    return string
}
